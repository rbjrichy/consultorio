...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/banner/banner.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/banner/banner2.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/banner/bradcam.png" alt="Third slide">
    </div>
  </div>
