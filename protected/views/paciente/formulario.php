...
<a href="#" onclick="document.getElementById('tbl-ingresarantecedentesdentales-form').reset(); $('#'+'dialogantecedentesdentales').dialog('open');">Nuevo Registro Antecedentes Dentales</a>
</div>
...
<a href="#" onclick="document.getElementById('tbl-ingresartratamiento-form').reset(); $('#'+'dialogtratamiento').dialog('open');">Nuevo Registro Tratamiento</a>
</div>
