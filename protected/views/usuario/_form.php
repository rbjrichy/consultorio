					...
					<tr>
						...
						<div class="row">
							...
							<?php 
								...
								echo $form->hiddenField($model,'idtipousuario',array('value' => 2));
								

								echo $form->labelEx($model,'nombreusuario'); ?>
							...
							<?php 
								//mandamos por hidden porque siempre creamos usuario tipo2 (investigador), solo el administrador crea otro tipo de usuarios
								echo $form->hiddenField($model,'idpaciente',array('value' => 2));
						...
						<div class="row">
	        				...
	        				$criteria->order = 'apellidos asc';
	        
	                         $lista = CHtml::listData(Paciente::model()->findAll($criteria),'id','nombrecompleto');
